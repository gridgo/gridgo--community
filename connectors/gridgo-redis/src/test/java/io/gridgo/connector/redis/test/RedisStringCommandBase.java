...
//                    }
    ...
    /**
     * List command
     * url: https://redis.io/commands#list
     */
    public void testRPUSH() throws InterruptedException {
        ...
        producer.call(Message.ofAny(buildCommand(RedisCommands.DEL), BArray.ofSequence("RPUSH")))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.RPUSH), BArray.ofSequence("RPUSH", "Hello", "World"))))
                .done(result -> {
                    var body = result.body().asValue().getLong();
                    if(body != 2) {
                        exRef.set(new RuntimeException("Body mismatch"));
    ...
    public void testRPUSHX() throws InterruptedException {
        ...
        producer.call(Message.ofAny(buildCommand(RedisCommands.DEL), BArray.ofSequence("RPUSHX")))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.RPUSHX), BArray.ofSequence("RPUSHX", "Hello", "World"))))
                .done(result -> {
                    var body = result.body().asValue().getLong();
                    if(body != 0) {
                        exRef.set(new RuntimeException("Body mismatch"));
    ...
    public void testLTRIM() throws InterruptedException {
        ...
        producer.call(Message.ofAny(buildCommand(RedisCommands.DEL), BArray.ofSequence("LTRIM")))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.RPUSH), BArray.ofSequence("LTRIM", "1", "2", "3", "4", "5", "6", "7"))))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.LTRIM), BArray.ofSequence("LTRIM", "0", "3"))))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.LRANGE), BArray.ofSequence("LTRIM", "0", "-1"))))
                .done(result -> {
                    var body = result.body().asArray();
                    if(body.size() != 4) {
                        exRef.set(new RuntimeException("Body mismatch"));
    ...
    public void testRPOP() throws InterruptedException {
        ...
        producer.call(Message.ofAny(buildCommand(RedisCommands.DEL), BArray.ofSequence("RPOP")))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.RPUSH), BArray.ofSequence("RPOP", "one", "two", "three"))))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.RPOP), "RPOP")))
                .done(result -> {
                    var body = result.body().asValue().getString();
    ...
    public void testRPOPLPUSH() throws InterruptedException {
        ...
        producer.call(Message.ofAny(buildCommand(RedisCommands.DEL), BArray.ofSequence("RPOPLPUSH1")))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.RPUSH), BArray.ofSequence("RPOPLPUSH1", "one", "two", "three"))))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.RPOPLPUSH), BArray.ofSequence("RPOPLPUSH1", "RPOPLPUSH2"))))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.LRANGE), BArray.ofSequence("RPOPLPUSH2", "0", "-1"))))
                .done(result -> {
                    var body = result.body().asArray();
                    if(body.size() == 0) {
                        exRef.set(new RuntimeException("Body mismatch"));
    ...
    public void testLRANGE() throws InterruptedException {
        ...
        producer.call(Message.ofAny(buildCommand(RedisCommands.DEL), BArray.ofSequence("LRANGE")))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.RPUSH), BArray.ofSequence("LRANGE", "1", "2", "3", "4", "5", "6", "7"))))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.LRANGE), BArray.ofSequence("LRANGE", "0", "-1"))))
                .done(result -> {
                    var body = result.body().asArray();
                    if(body.size() != 7) {
                        exRef.set(new RuntimeException("Body mismatch"));
    ...
    public void testLREM() throws InterruptedException {
        ...
        producer.call(Message.ofAny(buildCommand(RedisCommands.DEL), BArray.ofSequence("LREM")))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.RPUSH), BArray.ofSequence("LREM", "1", "2", "3", "4", "1", "6", "1"))))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.LREM), BArray.ofSequence("LREM", "-2", "1"))))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.LRANGE), BArray.ofSequence("LREM", "0", "-1"))))
                .done(result -> {
                    var body = result.body().asArray();
                    if(body.size() != 5) {
                        exRef.set(new RuntimeException("Body mismatch"));
    ...
    public void testLSET() throws InterruptedException {
        ...
        producer.call(Message.ofAny(buildCommand(RedisCommands.DEL), BArray.ofSequence("LSET")))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.RPUSH), BArray.ofSequence("LSET", "one", "two", "three"))))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.LSET), BArray.ofSequence("LSET", "-1", "four"))))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.RPOP), BArray.ofSequence("LSET"))))
                .done(result -> {
                    var body = result.body().asValue().getString();
    ...
    public void testLPOP() throws InterruptedException {
        ...
        producer.call(Message.ofAny(buildCommand(RedisCommands.DEL), BArray.ofSequence("LPOP")))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.RPUSH), BArray.ofSequence("LPOP", "one", "two", "three"))))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.LPOP), BArray.ofSequence("LPOP"))))
                .done(result -> {
                    var body = result.body().asValue().getString();
    ...
    public void testLPUSH() throws InterruptedException {
        ...
        producer.call(Message.ofAny(buildCommand(RedisCommands.DEL), BArray.ofSequence("LPUSH")))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.LPUSH), BArray.ofSequence("LPUSH", "one", "two", "three"))))
                .done(result -> {
                    var body = result.body().asValue().getLong();
                    if(body != 3) {
                        exRef.set(new RuntimeException("Body mismatch"));
    ...
    public void testLPUSHX() throws InterruptedException {
        ...
        producer.call(Message.ofAny(buildCommand(RedisCommands.DEL), BArray.ofSequence("LPUSHX")))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.LPUSHX), BArray.ofSequence("LPUSHX", "one", "two", "three"))))
                .done(result -> {
                    var body = result.body().asValue().getLong();
                    if(body != 0) {
                        exRef.set(new RuntimeException("Body mismatch"));
    ...
    public void testLINDEX() throws InterruptedException {
        ...
        producer.call(Message.ofAny(buildCommand(RedisCommands.DEL), BArray.ofSequence("LINDEX")))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.LPUSH), BArray.ofSequence("LINDEX", "one", "two", "three"))))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.LINDEX), BArray.ofSequence("LINDEX", "1"))))
                .done(result -> {
                    var body = result.body().asValue().getString();
    ...
    public void testLINSERT() throws InterruptedException {
        ...
        producer.call(Message.ofAny(buildCommand(RedisCommands.DEL), BArray.ofSequence("LINSERT")))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.LPUSH), BArray.ofSequence("LINSERT", "one", "three"))))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.LINSERT), BArray.ofSequence("LINSERT", "BEFORE", "three", "two"))))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.LINDEX), BArray.ofSequence("LINSERT", 1))))
                .done(result -> {
                    var body = result.body().asValue().getString();
                    if(!StringUtils.equals(body, "two")) {
                        exRef.set(new RuntimeException("Body mismatch"));
    ...
    public void testLLEN() throws InterruptedException {
        ...
        producer.call(Message.ofAny(buildCommand(RedisCommands.DEL), BArray.ofSequence("LLEN")))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.LPUSH), BArray.ofSequence("LLEN", "one", "three"))))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.LLEN), BArray.ofSequence("LLEN"))))
                .done(result -> {
                    var body = result.body().asValue().getLong();
                    if(body != 2) {
                        exRef.set(new RuntimeException("Body mismatch"));
    ...
    public void testBLPOP() throws InterruptedException {
        ...
        producer.call(Message.ofAny(buildCommand(RedisCommands.DEL), BArray.ofSequence("two")))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.RPUSH), BArray.ofSequence("two", "2", "3"))))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.BLPOP), BArray.ofSequence(1 , "one", "two"))))
                .done(result -> {
                    var body = result.body().asArray();
                    if(body.size() != 2) {
                        exRef.set(new RuntimeException("Body mismatch"));
    ...
    public void testBRPOP() throws InterruptedException {
        ...
        producer.call(Message.ofAny(buildCommand(RedisCommands.DEL), BArray.ofSequence("two")))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.RPUSH), BArray.ofSequence("two", "2", "3"))))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.BRPOP), BArray.ofSequence(1 , "one", "two"))))
                .done(result -> {
                    var body = result.body().asArray();
                    if(body.size() != 2) {
                        exRef.set(new RuntimeException("Body mismatch"));
    ...
    public void testBRPOPLPUSH() throws InterruptedException {
        ...
        producer.call(Message.ofAny(buildCommand(RedisCommands.DEL), BArray.ofSequence("BRPOPLPUSH1")))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.RPUSH), BArray.ofSequence("BRPOPLPUSH1", "one", "two", "three"))))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.RPOPLPUSH), BArray.ofSequence("BRPOPLPUSH1", "BRPOPLPUSH2"))))
                .pipeDone(result -> producer.call(Message.ofAny(buildCommand(RedisCommands.LRANGE), BArray.ofSequence("BRPOPLPUSH2", "0", "-1"))))
                .done(result -> {
                    var body = result.body().asArray();
                    if(body.size() == 0) {
                        exRef.set(new RuntimeException("Body mismatch"));
