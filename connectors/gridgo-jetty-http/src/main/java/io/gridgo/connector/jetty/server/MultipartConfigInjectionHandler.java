 ...
 * {@link org.eclipse.jetty.util.MultiPartInputStreamParser} in a servlet event
 * callback when the request is about to die but won't invoke it for a
 * non-servlet (webapp) handled request.
 *
 * <p>
...
class MultipartConfigInjectionHandler extends HandlerWrapper {
    ...
    /**
     * If you want to have multipart support in your handler, call this method each
     * time your doHandle method is called (prior to calling getParameter).
     *
     * Servlet 3.0 include support for Multipart data with its
     * {@link HttpServletRequest#getPart(String)} &
     * {@link HttpServletRequest#getParts()} methods, but the spec says that before
     * you can use getPart, you must have specified a {@link MultipartConfigElement}
     * for the Servlet.
     *
     * <p>
     * This is normally done through the use of the MultipartConfig annotation of
     * the servlet in question, however these annotations will not work when
     * specified on Handlers.
     *
     * <p>
     * The workaround for enabling Multipart support in handlers is to define the
     * MultipartConfig attribute for the request which in turn will be read out in
     * the getPart method.
     *
     * @see <a href="https://bugs.eclipse.org/bugs/show_bug.cgi?id=395000#c0">Jetty
     *      Bug tracker - Jetty annotation scanning problem (servlet workaround)
     *      </a>
     * @see <a href=
     *      "http://dev.eclipse.org/mhonarc/lists/jetty-users/msg03294.html">Jetty
    ...
    public void handle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (multipartRequest) {
                var multipartInputStream = (MultiPartFormInputStream) request.getAttribute(MULTIPART);
